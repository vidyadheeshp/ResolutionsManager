<?php 
	...
	$RID = $_POST['c1'];
	$CID = $_POST['c2'];
	$SID = 0; // only for Category 5 (general sanctions)
	
	date_default_timezone_set('Asia/Kolkata');
	$MDATE = date('Y-m-d');
	$status = 1;
	
	$remark= $_POST['c3']; // retrieves the custom status
	//Resolution Status Master Entry for status modification
